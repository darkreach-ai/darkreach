...
export const metadata: Metadata = {
  title: "About",
  description:
    "The mission, timeline, and technology behind darkreach — the world's biggest supercomputer.",
};
...
export default function AboutPage() {
  return (
    <>
      <PageHero
        eyebrow="About"
        title="We're building the world's biggest supercomputer"
        description="A distributed compute platform that turns idle machines into a global research network."
      />
        ...
        <ScrollAnimate>
          <div className="max-w-3xl space-y-4 text-muted-foreground leading-relaxed">
            <p>
              ...
              computational campaigns across a global network of operator nodes.
            </p>
            <p>
              ...
              tackle any embarrassingly parallel scientific computation, from
              protein folding to climate simulation.
            </p>
            <p>
              The project is fully open source under the MIT license. We believe
              scientific discoveries should be independently verifiable, the
              tools should be available to everyone, and the code should serve as
              a teaching resource for computational science.
            </p>
          </div>
        </ScrollAnimate>
      </Section>
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-md border border-border text-foreground hover:border-muted-foreground/30 transition-colors"
              >
                <Github size={20} />
                View on GitHub
              </a>
